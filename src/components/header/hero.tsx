...
export default function Hero() {
  return (
    <section id="hero" className="max-x-7xl my-5 mx-2 lg:mx-0">
      ...
      >
        <div className="px-3 py-2 border rounded-full hover:scale-105 transition-transform duration-75 shine shine-hover backdrop-blur-sm" style="background-color: rgba(70, 0,0, 0.8)">
